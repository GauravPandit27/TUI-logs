"""
CLI entry point — invoked by `superlog <file>` and `python -m superlog <file>`.
"""
import argparse
import sys
...
def main() -> None:
    parser = argparse.ArgumentParser(
        prog="superlog",
        description=(
            "SuperLog — Real-time structured log viewer and system monitor.\n\n"
        ...
        epilog=(
            ...
            "Examples:\n"
            "  superlog app.log\n"
            "  superlog /var/log/syslog\n"
            "  superlog app.log --max-lines 5000\n"
        ),
    )
